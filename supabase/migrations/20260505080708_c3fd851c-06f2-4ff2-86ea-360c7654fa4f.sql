...
(1, 'minijeu', 'CDHV01', 'Mini-jeu 1 — Placeholder',
  '{"riddle":"Mini-jeu placeholder n°1. Petite épreuve ludique."}'::jsonb,
...
(4, 'composee', 'CDHV04', 'Étape composée 4 — Placeholder',
  '{"intro":"Résolvez ces 3 mini-épreuves pour avancer.","subs":[
    ...
    {"kind":"minijeu","question":"Sous-mini-jeu n°3 ?","answer":"mini3","hint":"Indice mini 3"}
  ]}'::jsonb,
...
(6, 'minijeu', 'CDHV06', 'Mini-jeu 6 — Placeholder',
  '{"riddle":"Mini-jeu placeholder n°6. Petite épreuve ludique."}'::jsonb,
...
(7, 'composee', 'CDHV07', 'Étape composée 7 — Placeholder',
  '{"intro":"5 mini-épreuves vous attendent.","subs":[
    ...
    {"kind":"minijeu","question":"Mini-jeu 4 étape 7 ?","answer":"reponse74","hint":"Indice 7.4"},
...
(10, 'composee', 'CDHV10', 'Étape composée 10 — Placeholder',
  '{"intro":"4 défis à enchaîner.","subs":[
    ...
    {"kind":"minijeu","question":"Mini-jeu 10.3 ?","answer":"reponse103","hint":"Indice 10.3"},
...
(12, 'minijeu', 'CDHV12', 'Mini-jeu 12 — Placeholder',
  '{"riddle":"Mini-jeu placeholder n°12. Petite épreuve ludique."}'::jsonb,
...
(15, 'composee', 'CDHV15', 'Étape composée 15 — Placeholder',
  '{"intro":"3 mini-épreuves à résoudre ensemble.","subs":[
    {"kind":"minijeu","question":"Mini-jeu 15.1 ?","answer":"reponse151","hint":"Indice 15.1"},
...
(18, 'minijeu', 'CDHV18', 'Mini-jeu 18 — Placeholder',
  '{"riddle":"Mini-jeu placeholder n°18. Petite épreuve ludique."}'::jsonb,
...
(19, 'composee', 'CDHV19', 'Étape composée 19 — Placeholder',
  '{"intro":"Dernier marathon : 6 mini-épreuves.","subs":[
    ...
    {"kind":"minijeu","question":"Mini-jeu 19.3 ?","answer":"reponse193","hint":"Indice 19.3"},
    ...
    {"kind":"minijeu","question":"Mini-jeu 19.6 ?","answer":"reponse196","hint":"Indice 19.6"}
  ]}'::jsonb,
