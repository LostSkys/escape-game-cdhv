      ...
      <div className="max-w-3xl w-full text-center space-y-10 animate-fade-in-up">
        <header className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Formez votre équipe, résolvez les énigmes, explorez les salles et
            grimpez sur le podium.
          </p>
        </header>
        ...
        <div className="pt-8">
          <Link
            to="/admin"
            className="text-sm text-muted-foreground hover:text-primary transition-smooth inline-flex items-center gap-2"
          >
